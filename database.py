...
class DatabaseManager:
    ...
    def init_db(self):
        ...
        '''.replace('INTEGER PRIMARY KEY AUTOINCREMENT if sqlite else id INT AUTO_INCREMENT PRIMARY KEY', 
                   'INTEGER PRIMARY KEY AUTOINCREMENT' if self.db_type == 'sqlite' else 'INT AUTO_INCREMENT PRIMARY KEY'))
        ...
        if count == 0:
            ...
            self.execute_query("INSERT INTO users (username, password) VALUES (?, ?)", ('admin', hashed_pw))
